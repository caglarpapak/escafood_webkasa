...
transactionsRouter.post("/card-expense", validate(cardExpenseSchema), TransactionController.cardExpense);
transactionsRouter.post("/card-payment", validate(cardPaymentSchema), TransactionController.cardPayment);
transactionsRouter.delete("/:id", validate(idParamSchema, "params"), TransactionController.delete);
